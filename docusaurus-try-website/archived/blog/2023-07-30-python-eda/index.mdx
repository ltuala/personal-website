...
authors: [ltuala]
tags: [python, kaggle, baybayin, transfer learning]
---

I tried to explore [transfer learning](https://www.kaggle.com/code/karan842/cnn-vs-transfer-learning#What-is-transfer-learning-%F0%9F%AA%84) using [Keras](https://keras.io/) CNN on [Baybayin](https://en.wikipedia.org/wiki/Baybayin) dataset. 
